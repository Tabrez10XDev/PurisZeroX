function fullPage() {
  $("#js-fullpage").fullpage({
    ...
    scrollingSpeed: 1e3,
    anchors: ["top","services", "products", "about", "contact"],
    navigation: !0,
...
Barba.Dispatcher.on("newPageReady", function () {
  if ($("#js-fullpage").length)
    new Parallax($(".js-parallax-landing").get(0)),
      new Parallax($(".js-parallax-landinglight").get(0)),
...
function sendEmail() {
  var _emailBody = document.getElementById("etMessage").value;
  var _etName = document.getElementById("etName").value;
  var _etSubject = document.getElementById("etSubject").value;


  var email = "puriszerox@gmail.com";
  var subject = _etSubject 
  var emailBody = "From " + _etName + ", %0D    " + _emailBody;
